...
$w.onReady(function () {
	...
	highRiseBox.onMouseIn(() => {
		timeline()
			...
			.add(highRiseIcon, {y: 0, x: 0, scale: 1.1, rotate: 90, duration: 500, easing: 'easeOutCirc'})
			.play()
	})
	...
	highRiseBox.onMouseOut(() => {
		...
		timeline()
			...
			.add(highRiseIcon, {y: 0, x: 0, scale: 1, rotate: -90, duration: 200, easing: 'easeOutCirc'})
			.play()
	})
	...
	residentialBox.onMouseIn(() => {
		timeline()
			...
			.add(residentialIcon, {y: 0, x: 0, scale: 1.1, rotate: 90, duration: 500, easing: 'easeOutCirc'})
			.play()
	})
	...
	residentialBox.onMouseOut(() => {
		...
		timeline()
			...
			.add(residentialIcon, {y: 0, x: 0, scale: 1, rotate: -90, duration: 500, easing: 'easeOutCirc'})
			.play()
	})
	...
	hospitalityBox.onMouseIn(() => {
		timeline()
			...
			.add(hospitalityIcon, {y: 0, x: 0, scale: 1.1, rotate: 90, duration: 500, easing: 'easeOutCirc'})
			.play()
	})
	...
	hospitalityBox.onMouseOut(() => {
		...
		timeline()
			...
			.add(hospitalityIcon, {y: 0, x: 0, scale: 1, rotate: -90, duration: 500, easing: 'easeOutCirc'})
			.play()
	})
